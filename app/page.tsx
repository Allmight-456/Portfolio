...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-4 sm:p-6 lg:p-8">
      ...
      <main className="portfolio-container max-w-7xl mx-auto">
        <section className="landing-section min-h-screen px-4 sm:px-6 lg:px-8 section-transition">
          <nav className="py-10 mb-12 flex justify-between items-center dark:text-white relative">
            ...
            {/* Mobile menu */}
            <div className={`${mobileMenuOpen ? 'flex' : 'hidden'} lg:hidden absolute top-full right-0 left-0 bg-white/90 dark:bg-gray-800/90 backdrop-blur-md shadow-lg rounded-b-lg py-4 px-4 flex-col space-y-4 z-50`}>
              <a
                href="#projects"
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h3 className="text-xl sm:text-2xl py-2">Developer / Programmer</h3>
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-teal-300 max-w-2xl mx-auto px-4">
        ...
        {/* Skills section */}
        <section id="skills" className="skills-section px-4 sm:px-6 lg:px-8 py-20 section-transition">
          <div className="max-w-6xl mx-auto">
            <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-gray-800 dark:text-gray-200 flex-1 skill-card">
                <div className="flex justify-center">
        ...
        {/* Projects section */}
        <section className="projects-section px-4 sm:px-6 lg:px-8 py-20 section-transition" id="projects">
          <div className="max-w-6xl mx-auto">
